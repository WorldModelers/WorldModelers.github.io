...
![Model Specifics](../../images/dojo/registration-2-model-details.png)
...
![Add Region by Name](../../images/dojo/registration-3.1-model-region-name.png)
...
![Add Region by Bounding Box](../../images/dojo/registration-3.3-model-region-coords-search.png)
![Mapped Region by Bounding Box](../../images/dojo/registration-3.4-model-region-coords-added.png)
...
![Select Worker](../../images/dojo/provision-select.png)
...
![Provisioning](../../images/dojo/provisioning.png)
...
![Parameter Templater Tool](../../images/dojo/templater-highlight.png)
...
![Templater Editor Open](../../images/dojo/templater-annotation-panel.png)
...
![Templater Tooltip](../../images/dojo/templater-tooltip.png)
...
Once you have parameters saved to your configuration file, you can view a list of all of your current parameters by clicking the `View All Parameters` button.
 ...
 ![View All Parameters](../../images/dojo/templater-all-parameters.png)
...
![Directive Select](../../images/dojo/terminal-selecting-directive.png)

The same process applies to directive annotations as applied to [configuration annotation](#configuration-file-annotation).

![Directive With Parameter](../../images/dojo/directive-with-parameter.png)
...
![Terminal with Directive](../../images/dojo/terminal-with-directive.png)
...
![Terminal Edit File](../../images/dojo/terminal-edit-file.png)
